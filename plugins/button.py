...
def start_button(client):
    if not FORCE_SUB_CHANNEL1 and not FORCE_SUB_CHANNEL2 and not FORCE_SUB_CHANNEL3 and not FORCE_SUB_CHANNEL4:
        ...
        return buttons
    if not FORCE_SUB_CHANNEL1 and not FORCE_SUB_CHANNEL2 and not FORCE_SUB_CHANNEL3 and FORCE_SUB_CHANNEL4:
        buttons = [
            [
                InlineKeyboardButton(text="CHANNEL4", url=client.invitelink4),
            ],
            [
                InlineKeyboardButton(text="ʜᴇʟᴘ & ᴄᴏᴍᴍᴀɴᴅs", callback_data="help"),
                InlineKeyboardButton(text="ᴛᴜᴛᴜᴘ", callback_data="close"),
        ...
        return buttons
    if not FORCE_SUB_CHANNEL1 and not FORCE_SUB_CHANNEL4 and not FORCE_SUB_CHANNEL2 and FORCE_SUB_CHANNEL3:
        buttons = [
            [
    ...
    if FORCE_SUB_CHANNEL1 and not FORCE_SUB_CHANNEL2 and not FORCE_SUB_CHANNEL3 and not FORCE_SUB_CHANNEL4:
        buttons = [
            [
                InlineKeyboardButton(text="CHANNEL1", url=client.invitelink1),
            ],
            [
                InlineKeyboardButton(text="ʜᴇʟᴘ & ᴄᴏᴍᴍᴀɴᴅs", callback_data="help"),
                InlineKeyboardButton(text="ᴛᴜᴛᴜᴘ", callback_data="close"),
...
def fsub_button(client, message):
    if not FORCE_SUB_CHANNEL1 and not FORCE_SUB_CHANNEL2 and not FORCE_SUB_CHANNEL3 and FORCE_SUB_CHANNEL4:
        buttons = [
            [
                InlineKeyboardButton(text="ᴊᴏɪɴ CHANNEL4", url=client.invitelink4),
            ],
        ]
        try:
            buttons.append(
            ...
            pass
        return buttons
    if not FORCE_SUB_CHANNEL1 and not FORCE_SUB_CHANNEL2 and not FORCE_SUB_CHANNEL4 and FORCE_SUB_CHANNEL3:
        buttons = [
            [
